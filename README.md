...
- Local deterministic cumulative-stack rule layer for QT, bleeding, serotonergic, anticholinergic syndrome, extrapyramidal syndrome, ergotism, drug-induced lactic acidosis, nephrotoxic, potassium, and glucose burden
...
| M5 | Local deterministic cumulative stacks: QT, bleeding, serotonergic, anticholinergic syndrome, extrapyramidal syndrome, ergotism, drug-induced lactic acidosis, nephrotoxic, hyperkalemia, hypokalemia, hypoglycemia, hyperglycemia |
...
| `lib/stacks.ts` local rules | Deterministic cumulative stack warnings and citations | `2026-04-cardiometabolic` | Repo-managed | Client-side M5 stack layer |
