...
| `lib/stacks.ts` local rules | Deterministic cumulative stack warnings | `2026-04-cardiometabolic` | Repo-managed | Repository-local authored content | Client-side M5 cumulative risk layer with visible citations, now including potassium and glucose stack rules. |
