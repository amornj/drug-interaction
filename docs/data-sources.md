...
| Curated brand YAML | Hand-curated brand and combo expansions | `2026-04`, generated `2026-04-23` | Manual, repo-driven | Repository-local authored content | Stored in `lib/data/brands/*.yaml`, validated with `zod`, emitted into `lib/data/brands/index.json`. |
